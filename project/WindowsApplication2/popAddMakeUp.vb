Public Class popAddMakeUp
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles bttnAdd.Click
    ...
    Private Sub dtpFiled_ValueChanged(sender As Object, e As EventArgs) Handles dtpFiled.ValueChanged
