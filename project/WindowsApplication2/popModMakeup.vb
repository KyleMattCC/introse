Public Class popModMakeup
    ...
    Private Function Check_Entry(makeup As String, courseofferingid As String, stat As String) As Boolean
        ...
        att = dbAccess.getData("select makeupid from introse.makeup where makeup_date = '" & makeup & "'and courseoffering_id = '" & courseofferingid & "' and status = '" & stat & "';", "attendanceid")
