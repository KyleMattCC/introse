...
Public Class ReportGenerator
    ...
    Public Function generateNotice(idnumber As String, name As String, absdate As Date) As String
        ...
        Dim attendanceid As New Integer
        ...
        Dim checkers As New List(Of String)

        attendanceid = dbAccess.getIntData("select a.attendanceid
        ...
        For i = 0 To courses.Count - 1
            ...
            table.AddCell(courses.Item(i).ToString)
            table.AddCell(sections.Item(i))
            table.AddCell(starttimes.Item(i) & "-" & endtimes.Item(i))
            table.AddCell(rooms.Item(i))
            table.AddCell(remarks.Item(i))
            table.AddCell(checkers.Item(i))
        Next i
        ...
        dbAccess.updateData("update introse.attendance set report_status = 'Generated' where attendanceid = '" & attendanceid & "';")
