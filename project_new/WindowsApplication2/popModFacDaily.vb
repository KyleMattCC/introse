Public Class wdwModFacultyDaily
    ...
    Private Sub ComboBox3_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbbxRemarks.SelectedIndexChanged
        TextBox9.Text = cmbbxRemarks.SelectedItem.ToString
        If String.IsNullOrEmpty(cmbbxRemarks.SelectedItem) Then
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If Convert.ToInt32(ref) > 0 Then
            ...
            remarks = dbAccess.getStringData("SELECT remark_cd FROM remarks where remark_des = '" & cmbbxRemarks.SelectedItem & "';", "remark_cd")
